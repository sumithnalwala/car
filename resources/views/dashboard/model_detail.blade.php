		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<form method="post"  id="model_add_form" autocomplete="off" enctype="multipart/form-data">
						    @csrf
					     <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Model Number</label>
                            <div class="col-sm-12 col-md-4">
                                <input class="form-control" name="model_number"  id="model_number" value="{{ old('model_no') }}" type="text" placeholder="model Number" data-error="Please Enter Model Number " required>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-4">
                               <input class="form-control" name="colour"  id="colour"  value="{{ old('colour') }}" type="text" placeholder="color" data-error="Please Enter Colour of Model " required>
                            </div>
                             <label class="col-sm-12 col-md-2 col-form-label">Manufacture Year</label>
                            <div class="col-sm-12 col-md-4">
                            <input class="form-control " name="manufacturer_year" id="manufacturer_year" value="{{ old('manufacturer_year') }}" placeholder="Manufacture year" type="text" data-error="Please Enter Manufacturing year" required>
                            </div>           
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Ragistration Number</label>
                            <div class="col-sm-12 col-md-4">
                               <input class="form-control" name="register_number"  id="register_number" type="text"  value="{{ old('reghister_number') }}" placeholder="Registration Number" data-error="Please Enter Registation Number" required>
                            </div>
                            <label class="col-sm-12 col-md-2 col-form-label">Note</label>
                            <div class="col-sm-12 col-md-4">
                            <textarea  class="form-control " name="note" id="note" value="{{ old('note') }}" data-error="Please Enter Note" placeholder="Note" required></textarea>
                            </div>           
                        </div>
                        <div class="form-group row">      
                            <label class="col-sm-12 col-md-2 col-form-label">first picture</label>
                            <div class="col-sm-12 col-md-4">
                            <input class="form-control" type="file" id="picture1" name="picture1" value="" placeholder="" data-error="Please Enter first picture" required>
                            </div>
                            <label class="col-sm-12 col-md-2 col-form-label">second picture</label>
                            <div class="col-sm-12 col-md-4">
                            <input class="form-control" type="file" id="picture2" name="picture2" value="" placeholder="" data-error="Please Enter Second picture" required>
                            </div>                  
                        </div>
                        <div class="form-group row">      
                            <label class="col-sm-12 col-md-2 col-form-label">Quantity</label>
                            <div class="col-sm-12 col-md-4">
                            <input class="form-control" type="text" id="quantity" name="quantity" value="" placeholder="" data-error="Please Enter quantity" required>
                            </div>
                        </div>
                        <div  class="form-group row">
